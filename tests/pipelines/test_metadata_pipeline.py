...
from offchain.adapters.http_adapter import HTTPAdapter
from offchain.adapters.ipfs import IPFSAdapter
...
from offchain.pipelines.metadata_pipeline import AdapterConfig, MetadataPipeline
...
class TestMetadataPipeline:
    ...
    def test_metadata_pipeline_errors_with_no_parser(self):
        ...
        pipeline = MetadataPipeline(parsers=[])
        assert pipeline.run(tokens=[token]) == [
